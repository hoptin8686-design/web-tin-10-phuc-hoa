  ...
  return (
    <div className="my-5 rounded-2xl border-2 border-dashed border-sea/40 bg-sea/[0.06] p-4 sm:p-5">
      <p className="font-display text-sm font-semibold text-sea-deep">
        🤔 Thử kiểm tra xem em đã nắm chắc chưa
      </p>
...
function RenderBlock({ block }: { block: TheoryBlock }) {
  switch (block.kind) {
    ...
    case "code":
      return (
        <div className="my-4 overflow-hidden rounded-xl border border-star/15 bg-[#07131b]">
          ...
          <pre className="overflow-x-auto p-4 font-mono text-xs sm:text-sm text-sea-deep">
    ...
    case "example":
      return (
        <div className="my-4 rounded-xl border border-sea/30 bg-sea/[0.08] p-4">
          <p className="font-display text-xs font-bold uppercase tracking-wider text-sea-deep">
      ...
      return (
        <div className="my-4 rounded-xl border-l-4 border-gold bg-gold/[0.1] p-4 text-star">
          <div className="flex items-center gap-1.5 font-display text-sm font-bold text-gold-deep">
            <span>📌</span>
            <span>Điều cốt lõi phải nhớ:</span>
          </div>
