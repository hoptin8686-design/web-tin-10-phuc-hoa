    ...
    <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6">
      ...
      <div className="flex items-center justify-between gap-3 border-b border-star/10 pb-3">
        ...
        <span className="font-mono text-xs text-gold-deep">
          Tự luận & Bài tập vận dụng ({questions.length} bài)
        </span>
      </div>
        ...
        {questions.map((q, idx) => {
          ...
          return (
            ...
            >
              ...
              {q.code && (
                <pre className="mt-3 overflow-x-auto rounded-xl border border-star/10 bg-[#07131b] p-3 font-mono text-xs sm:text-sm text-sea-deep">
                  <code>{q.code}</code>
                </pre>
              )}
              ...
              <div className="mt-4">
                ...
                <textarea
                  ...
                  placeholder="Gõ nháp các bước tính toán, suy luận hoặc viết code Python tại đây..."
                  rows={4}
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                >
                  <span>{isOpen ? "Ẩn hướng dẫn đáp án" : "🔍 Xem đáp án đối chiếu"}</span>
                </button>
              ...
              {isOpen && (
                <div className="mt-4 animate-pop-in rounded-xl border border-leaf/30 bg-leaf/[0.08] p-4">
                  <div className="flex items-center gap-1.5 font-display text-sm font-bold text-leaf-deep">
                    <span>💡</span>
                    <span>Hướng dẫn giải chi tiết & Đáp án chuẩn:</span>
                  </div>
