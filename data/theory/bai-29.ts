...
const bai29: LessonTheory = {
  intro: "Nội dung Bài 29 trình bày các kiến thức cốt lõi về môn Tin học lớp 10, giúp các em học sinh nắm vững lý thuyết và vận dụng vào thực tế.",
  minutes: 15,
  sections: [
    {
